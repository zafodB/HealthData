...
if on_server:
    ...
    output_directory_data = "/scratch/GW/pool0/fadamik/ehealthforum/trac/noent/data"
    # output_directory_maps = "/scratch/GW/pool0/fadamik/ehealthforum/trac/noent/maps"
    output_directory_queries = "/scratch/GW/pool0/fadamik/ehealthforum/trac/noent/queries"
